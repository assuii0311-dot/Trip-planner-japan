...
export const EXTRAS = [
  ...
  },
  {
    ...
    bestSlots: ['afternoon', 'evening'], indoor: false, tags: ['골목', '먹거리'],
  ...
  // ── 신주쿠 ───────────────────────────────────────────────────────
  {
    ...
    bestSlots: ['evening', 'night'], indoor: false, tags: ['이자카야', '꼬치', '대표'],
  ...
  },
  {
    ...
    bestSlots: ['night'], indoor: true, tags: ['바', '대표'],
  ...
  },
  {
    ...
    bestSlots: ['morning', 'afternoon'], indoor: false, tags: ['크레이프', '10대'],
  ...
  },
  {
    ...
    bestSlots: ['morning', 'afternoon', 'evening'], indoor: false, tags: ['건축', '느티나무길'],
  ...
  },
  {
    ...
    bestSlots: ['afternoon', 'evening', 'night'], indoor: false, tags: ['옥상공원', '요코초'],
  ...
  // ── 롯폰기·도쿄타워 ───────────────────────────────────────────────
  {
    ...
    theme: 'shopping', durationMin: 60, priceJpy: 0, energy: 1, popularity: 3,
    bestSlots: ['afternoon', 'evening'], indoor: true, tags: ['복합시설', '정원'],
  ...
  // ── 긴자·쓰키지 / 도쿄역·황거 ───────────────────────────────────────
  {
    ...
    bestSlots: ['morning', 'afternoon', 'evening'], indoor: true, tags: ['백화점', '옥상정원', '쓰타야'],
  ...
  },
  {
    ...
    bestSlots: ['afternoon'], indoor: false, tags: ['책', '카레'],
  ...
  },
  {
    ...
    theme: 'shopping', durationMin: 60, priceJpy: 0, energy: 1, popularity: 4,
    bestSlots: ['afternoon', 'evening'], indoor: true, tags: ['피규어', '트레이딩카드'],
  ...
  },
  {
    ...
    bestSlots: ['morning', 'lunch'], indoor: true, tags: ['스시', '참치경매', '아침'],
  ...
  },
  {
    ...
    theme: 'shopping', durationMin: 60, priceJpy: 0, energy: 1, popularity: 3,
    bestSlots: ['afternoon', 'evening'], indoor: false, tags: ['애니메이션', '여성향'],
  ...
  },
  {
    ...
    bestSlots: ['evening', 'night'], indoor: false, tags: ['이자카야', '골목'],
  ...
  // ── 가마쿠라·에노시마 ─────────────────────────────────────────────
  {
    ...
    bestSlots: ['morning', 'afternoon'], indoor: false, tags: ['먹거리', '기념품'],
  ...
  // ── 가와고에 / 가와구치코 ──────────────────────────────────────────
  {
    ...
    theme: 'history', durationMin: 75, priceJpy: 0, energy: 2, popularity: 5,
    bestSlots: ['morning', 'afternoon'], indoor: false, tags: ['옛거리', '대표'],
  ...
  },
  {
    ...
    bestSlots: ['morning', 'afternoon'], indoor: false, tags: ['상점가'],
